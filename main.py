...
def generate_background_image(title):
  ...
  """
    user_input = "Generate a prompt that generates a dull and light mostly white coloured image that can be used as a background for text written in black for my power point presentation. Make sure the images doesn't contain any text or logo. Don't used dark colours. "
    # user_input = "Generate a prompt that generates a solid background with the gradient Hex-code 3f4041 with a blue broder of 2px width"
...
generate_presentation_using_topic("Session for Mongo DB")